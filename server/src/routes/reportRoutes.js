...
router.get('/', requireRole('admin', 'captain', 'secretary', 'kagawad', 'tanod', 'responder'), getReports);
router.get('/:id', getReportById);
router.post('/:id/verify', requireRole('secretary'), verifyReport);
router.post('/:id/flag', requireRole('secretary'), flagReport);
router.patch('/:id/status', requireRole('secretary', 'kagawad', 'tanod', 'responder'), updateReportStatus);
router.patch('/:id/acknowledge', requireRole('tanod', 'responder', 'captain', 'secretary'), acknowledgeReport);
