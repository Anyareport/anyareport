...
export default function ResidentLanding() {
  ...
  return (
    <div>
      <Card style={{ marginBottom: 16, background: 'linear-gradient(135deg, #282F49 0%, #3d4666 100%)', border: 'none' }}>
        <Title level={2} style={{ color: '#fff', fontFamily: "'Bebas Neue', sans-serif", letterSpacing: 2, margin: 0 }}>
          REPORT AN INCIDENT
        </Title>
        <Paragraph style={{ color: '#ccc', marginBottom: 16 }}>
          Help keep Barangay Don Mariano Marcos safe. Report concerns, emergencies, and infrastructure issues directly from your phone.
        </Paragraph>
        <Button
          type="primary"
          size="large"
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12}>
          <Card>
            ...
            <Title level={5} style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: 1, marginTop: 8 }}>
              QUICK REPORTING
            </Title>
            <Paragraph type="secondary">
              Use GPS and photos to report incidents on the spot. Our team responds quickly to verified reports.
            </Paragraph>
          </Card>
        </Col>
        <Col xs={24} sm={12}>
          <Card>
            ...
            <Button type="link" onClick={() => navigate('/resident/reports')} style={{ padding: 0 }}>
              View My Reports →
            </Button>
          </Card>
        </Col>
